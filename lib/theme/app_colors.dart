...
class AppColors {
  ...
  static const Color onSurface = Color.fromARGB(
    255,
    163,
    163,
    163,
  ...
  static const Color darkSurfaceOverlay = Color(
    0x4025367B,
  ); // Overlay translúcido
  ...
  static const List<BoxShadow> glowShadow = [
    BoxShadow(color: Color(0x306C5CE7), blurRadius: 20, offset: Offset(0, 0)),
  ];
  ...
  static EditorColors getEditorColors(
    ThemeMode themeMode,
