...
class ErrorMessageMapper {
  ...
  static String map(dynamic error) {
    ...
    if (msg.contains('not found') || msg.contains('does not exist') || msg.contains('no existe')) {
      return 'El elemento no existe o fue eliminado';
    }
    
    // Errores de duplicados
    if (msg.contains('already exists') || msg.contains('duplicate') || msg.contains('ya existe')) {
      return 'Ya existe un elemento con ese nombre';
    }
    
    // Errores de validación
    if (msg.contains('invalid') || msg.contains('inválido') || msg.contains('formato')) {
