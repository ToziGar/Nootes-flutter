...
class StorageService {
  static Future<String> uploadBytes({required String uid, required Uint8List bytes, required String filename, String contentType = 'application/octet-stream'}) async {
