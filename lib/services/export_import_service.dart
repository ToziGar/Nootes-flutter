...
import 'export_import_service_stub.dart'
    ...
    if (dart.library.io) 'export_import_service_io.dart'
    as platform;
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        throw UnimplementedError(
          'Exportar en plataformas nativas aún no implementado',
        );
      }
    } catch (e) {
...
''';
        ...
        if (kIsWeb) {
          ...
          // TODO: Implementar para plataformas móviles/desktop
          throw UnimplementedError(
            'Exportar Markdown en plataformas nativas aún no implementado',
          );
        }
      }
    } catch (e) {
  ...
  static Future<void> exportSingleNoteToMarkdown(
...
''';
  ...
  static Future<List<Map<String, dynamic>>> importFromJson(
    String jsonString,
  ) async {
    try {
  ...
  static Map<String, dynamic> getNotesStatistics(
    List<Map<String, dynamic>> notes,
  ) {
    ...
    return {
      ...
      'averageWordsPerNote': totalNotes > 0
