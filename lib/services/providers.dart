...
final syncServiceProvider = Provider<dynamic>((ref) {
  final storage = ref.watch(queueStorageProvider);
  final repo = ref.watch(noteRepositoryProvider);
  final fs = ref.watch(firestoreServiceProvider);
  // Create SyncService via dynamic invocation to avoid static type resolution
  // while the workspace is stabilizing. The concrete class is defined in
  // lib/services/sync_service.dart and will be picked up at runtime.
