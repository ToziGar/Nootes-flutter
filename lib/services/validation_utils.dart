...
class ValidationUtils {
  ...
  static T validateInList<T>(T? value, List<T> allowedValues, String fieldName) {
    final validated = validateNotNull(value, fieldName);
  ...
  static String validateId(String? id, [String fieldName = 'ID']) {
    ...
    if (trimmed.length < 3 || trimmed.length > 50) {
      throw ValidationException('$fieldName debe tener entre 3 y 50 caracteres');
    }
  ...
  static String validateUsername(String? username, [String fieldName = 'nombre de usuario']) {
  ...
  static DateTime validateFutureDate(DateTime? date, [String fieldName = 'fecha']) {
  ...
  static String sanitizeHtml(String? html, [String fieldName = 'contenido HTML']) {
