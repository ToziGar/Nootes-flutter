...
class _ShareDialogState extends State<ShareDialog> {
  ...
  Future<void> _share() async {
    ...
    try {
      ...
      print('📤 Iniciando compartir: ${widget.itemType.name} ${widget.itemId}');
      print('👤 Destinatario: $recipientIdentifier');
      print('🔐 Permisos: ${_selectedPermission.name}');
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Icon(Icons.people_alt_rounded, size: 20, color: AppColors.primary),
                                      ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Compartido con ${_sharedByMe.length} persona${_sharedByMe.length != 1 ? 's' : ''}',
                                              style: TextStyle(
                                            ...
                                            Text(
                                              'Gestiona los accesos existentes',
                                              style: TextStyle(
                                                color: AppColors.textSecondary,
                                                fontSize: 13,
                                              ),
                        ...
                        // Mensaje cuando no hay comparticiones
                        if (!_loadingExisting && _sharedByMe.isEmpty)
                          _buildNoSharesHint(),

                        // Enlace público (solo para notas)
                        if (widget.itemType == SharedItemType.note) 
                          Container(
                            margin: const EdgeInsets.only(bottom: 24),
                            child: _buildPublicLinkCard(),
                          ),

                        // Formulario de nueva compartición
                        Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius: BorderRadius.circular(16),
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: 4),
                                              Text(
                                                'Ej: usuario@ejemplo.com o @usuario',
                                                style: TextStyle(
                                                  color: AppColors.textSecondary,
                                                  fontSize: 12,
                                                ),
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return ListTile(
                                            ...
                                            trailing: Icon(Icons.arrow_forward_ios_rounded, size: 12, color: AppColors.textSecondary),
                                            onTap: () {
                                              setState(() {
                            ...
                            if (_errorMessage != null)
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.info_outline_rounded, color: AppColors.danger, size: 16),
