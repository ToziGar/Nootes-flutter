...
class _EditorSettingsDialogState extends State<EditorSettingsDialog> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildToggleOption(
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(syntaxHighlighting: value),
                      ),
                    ),
                    _buildToggleOption(
                      'Autocompletado',
                      ...
                      (value) =>
                          _updateConfig(_config.copyWith(autoComplete: value)),
                    ),
                    _buildToggleOption(
                      'Números de línea',
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(showLineNumbers: value),
                      ),
                    ),
                    _buildToggleOption(
                      'Minimap',
                      ...
                      _config.showMinimap,
                      (value) =>
                          _updateConfig(_config.copyWith(showMinimap: value)),
                    ),
                    _buildToggleOption(
                      'Ajuste de línea',
                      ...
                      _config.wordWrap,
                      (value) =>
                          _updateConfig(_config.copyWith(wordWrap: value)),
                    ),
                    ...
                    _buildSliderOption(
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(tabSize: value.toInt()),
                      ),
                    ),
                    _buildToggleOption(
                      'Insertar espacios',
                      ...
                      (value) =>
                          _updateConfig(_config.copyWith(insertSpaces: value)),
                    ),
                    ...
                    _buildToggleOption(
                      ...
                      _config.autoSave,
                      (value) =>
                          _updateConfig(_config.copyWith(autoSave: value)),
                    ),
                    if (_config.autoSave)
                      _buildSliderOption(
                        ...
                        (value) => _updateConfig(
                          _config.copyWith(autoSaveDelay: value.toInt()),
                        ),
                      ),
                    _buildToggleOption(
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(bracketMatching: value),
                      ),
                    ),
                    _buildToggleOption(
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(showWhitespace: value),
                      ),
                    ),
                    _buildToggleOption(
                      ...
                      (value) => _updateConfig(
                        _config.copyWith(trimTrailingWhitespace: value),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildToggleOption(
    ...
    return Card(
      ...
      child: ListTile(
        leading: Icon(icon, color: value ? AppColors.primary : Colors.grey),
        title: Text(title),
        subtitle: Text(
          subtitle,
