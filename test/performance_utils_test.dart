  ...
  group('PerformanceUtils Tests', () {
    ...
    group('BatchOperationUtils', () {
      test('executeBatch processes operations in batches', () async {
        // Arrange
        final operations = List.generate(25, (i) => () async => i);
      ...
      test('executeBatch handles empty operations list', () async {
        // Act
        final results = await BatchOperationUtils.executeBatch(<Future<int> Function()>[]);
    ...
    group('DebounceUtils', () {
      ...
      test('cancelAllDebounces cancels all pending operations', () async {
        ...
        // Act
        DebounceUtils.debounce('key1', const Duration(milliseconds: 50), () => executionCount++);
        DebounceUtils.debounce('key2', const Duration(milliseconds: 50), () => executionCount++);
        DebounceUtils.debounce('key3', const Duration(milliseconds: 50), () => executionCount++);
    ...
    group('ResourceManager', () {
      ...
      test('releaseResource handles non-existent resource gracefully', () {
        ...
        expect(() => ResourceManager.releaseResource('non_existent'),
               returnsNormally);
      });
    });
  });
