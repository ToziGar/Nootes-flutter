...
void main() {
  ...
  group('Firestore emulator integration', () {
    ...
    setUpAll(() async {
      ...
      try {
        // Only initialize and attach to emulator if it's reachable. This
        // prevents SocketException when CI or local env sets the
        // FIRESTORE_EMULATOR_HOST but the emulator process isn't running.
